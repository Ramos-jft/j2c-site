    ...
    <main id="conteudo" className="mx-auto max-w-6xl px-4 py-10">
        ...
        <div className="flex flex-col gap-6">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold tracking-tight sm:text-4xl">
              Geotecnia com drone para barragens e obras urbanas: mais controle
              de risco, menos incerteza
            </h1>
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/80">
              Inspeções e levantamentos de alta resolução (ortomosaico e modelos
              digitais do terreno) para apoiar decisões em segurança de
              barragens, estabilidade de taludes, contenções e obras em áreas
              urbanas — com relatório técnico claro, rastreabilidade e, quando
              aplicável, ART. Operação do drone conforme RBAC-E 94 (ANAC) e
              solicitações de espaço aéreo via DECEA/SARPAS.
            </p>
      ...
      <section className="mt-10">
        ...
        <p className="mt-2 text-sm text-white/70">
          Selecione o serviço para ver quando contratar, entregáveis típicos e o
          que você precisa enviar para triagem.
        </p>
